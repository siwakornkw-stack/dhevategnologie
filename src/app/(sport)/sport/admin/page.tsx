    ...
    <div className="wrapper py-8 space-y-8 max-w-6xl">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
          ...
          <Link
            href="/sport/pos"
            className="flex-shrink-0 px-3 py-2 rounded-full bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition whitespace-nowrap"
          >
            POS
          </Link>
          <Link
